    ...
    (<SidebarProvider>
      <Sidebar collapsible="icon">
        <SidebarHeader className="flex items-center justify-between px-4">
          <h2
            className="text-lg font-semibold tracking-tight group-data-[collapsible=icon]:hidden">Location App</h2>
          <SidebarTrigger>
            <Button
              variant="ghost"
              size="icon"
                  ...
                  <TooltipTrigger asChild>
                    <SidebarMenuButton asChild isActive={pathname === '/submit'}>
                      <Link href="/submit" className="flex items-center">
                        ...
                        <span className="group-data-[collapsible=icon]:hidden">Submit</span>
                      </Link>
                    </SidebarMenuButton>
                  </TooltipTrigger>
                  ...
                  <TooltipTrigger asChild>
                    <SidebarMenuButton asChild isActive={pathname === '/locations'}>
                      <Link href="/locations" className="flex items-center">
                        ...
                        <span className="group-data-[collapsible=icon]:hidden">All Locations</span>
                      </Link>
                    </SidebarMenuButton>
                  </TooltipTrigger>
                  <TooltipContent side="right" className="group-data-[collapsible=icon]:block hidden">
